...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val age: TextView = itemView.findViewById(R.id.dog_age)
        val hobbies: TextView = itemView.findViewById(R.id.dog_hobbies)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.name.text = context.resources.getString(item.stringResourceId)
        ...
        holder.name.text = resources?.getString(R.string.dog_age)
        holder.age.text
        holder.hobbies.text
    }
}
